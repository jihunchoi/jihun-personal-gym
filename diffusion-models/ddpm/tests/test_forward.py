...
def test_initialization():
    ...
    assert torch.allclose(forward_process.alpha_bars[1], forward_process.alphas[0] * forward_process.alphas[1])
...
def test_add_noise_scalar_t():
    ...
    expected_x_t = alpha_bar_t_reshaped * x_0 + torch.sqrt(1 - alpha_bar_t_reshaped**2) * noise
...
def test_add_noise_tensor_t():
    ...
    for i in range(batch_size):
        ...
        expected_x_t_i = alpha_bar_i * x_0[i] + torch.sqrt(1 - alpha_bar_i**2) * noise[i]
